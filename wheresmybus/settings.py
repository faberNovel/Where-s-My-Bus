# Django settings for wheresmybus project.

import os.path

import secrets

# Will be modified by Fabric (with sed)
ENV = "testing"
PROJECT_DIR = os.path.dirname(__file__)

if ENV == "testing":
    LOGGING_DIR = "/usr/local/var/log/wheresmybus/"
else:
    LOGGING_DIR = "/var/log/wheresmybus/"

SITE_ID = secrets.SITE_IDS[ENV]
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'maxBytes': 50000,
            'backupCount': 2,
            'filename': os.path.join(LOGGING_DIR, "error_" + ENV + ".log"),
        },
    },
    'loggers': {
        'django': {
